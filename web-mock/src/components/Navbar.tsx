    ...
    >
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6 lg:px-8">
        ...
        <div className="hidden md:flex items-center space-x-8 text-sm font-medium text-slate-400">
          <a href="#features" className="hover:text-white transition-colors duration-300">Developer Experience</a>
        ...
        <div className="flex items-center gap-4">
          <a href="https://github.com/unuko/unuko" className="hidden sm:flex text-sm font-medium text-slate-400 hover:text-white transition-colors duration-300">
            Documentación
          </a>
          <button className="flex items-center gap-2 rounded-lg bg-white/5 border border-white/10 px-4 py-2 text-sm font-semibold text-white shadow-lg transition-all hover:bg-white/10 hover:scale-105 hover:shadow-indigo-500/10 backdrop-blur-md">
