    ...
    <div className="h-full flex flex-col p-6 bg-transparent relative overflow-hidden animate-in fade-in duration-500">
      <div className="w-full flex flex-col gap-6 flex-1 min-h-0">
        <PageHeader
          title="Network"
          highlight="Topology"
          subtitle="Lima Environment Core Topology"
          actions={
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-1.5 text-[9px] font-mono text-emerald-400 uppercase tracking-widest font-bold bg-emerald-500/10 border border-emerald-500/20 px-2.5 py-1 rounded-sm">
              ...
              <Button 
                ...
                variant="outline" 
                size="sm" 
                className="h-8 text-[10px] font-bold uppercase tracking-wider gap-1.5 text-indigo-400 hover:text-indigo-300 hover:bg-indigo-500/10 cursor-pointer"
              >
              ...
              <Button 
                ...
                variant="outline" 
                size="sm" 
                className="h-8 text-[10px] font-bold uppercase tracking-wider gap-1.5 text-slate-400 hover:text-slate-200 cursor-pointer"
              >
